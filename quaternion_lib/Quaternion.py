...
http://robotics-toolbox-python.googlecode.com/svn-history/r22/trunk/robotics-toolbox-python/robot
"""
...
'''
        ...
        if len(args) == 0:
            ...
            if isinstance(arg, (matrix, ndarray)): # initially here was "type(arg) is matrix"", vz
...
# Copyright (C) 1999-2002, by Peter I. Corke
    ...
    def slerp_interp(Q1, Q2, r):
        ...
        if isscalar(r):
            if r<0 or r>1:
                raise ValueError('r = {} out of range [0,1]'.format(r))
            if theta == 0:
                q = quaternion(Q1)
            else:
